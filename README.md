...
dependencies {
    // Core API (required)
    implementation("xyz.bitsquidd.bits:api:0.0.24")

    // Platform implementations
    implementation("xyz.bitsquidd.bits.paper:paper:0.0.24")
    implementation("xyz.bitsquidd.bits.velocity:velocity:0.0.24")
    implementation("xyz.bitsquidd.bits.fabric:fabric:0.0.24")

    // Optional: Platform-specific modules
    implementation("xyz.bitsquidd.bits.paper:sendable:0.0.24")
    implementation("xyz.bitsquidd.bits.paper:command:0.0.24")
    implementation("xyz.bitsquidd.bits.velocity:command:0.0.24")
}
```
