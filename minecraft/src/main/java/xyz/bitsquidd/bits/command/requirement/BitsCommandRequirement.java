 ...
 * <p>
 * Implementations of this class can be applied to commands using the {@link xyz.bitsquidd.bits.command.annotation.Requirement}
 * annotation or dynamically via {@link xyz.bitsquidd.bits.command.BitsCommand#getAddedRequirements()}.
 * <p>
 * Example usage:
 * <pre>{@code
