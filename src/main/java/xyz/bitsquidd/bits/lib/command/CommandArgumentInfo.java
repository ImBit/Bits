...
public class CommandArgumentInfo<T> {
    ...
    public final @NotNull CommandArgument<T> param;
    @ApiStatus.Experimental public final @Nullable T defaultValue;

    public CommandArgumentInfo(@NotNull String name, @NotNull CommandArgument<T> param) {
        this(name, param, null);
    }

    @ApiStatus.Experimental
    public CommandArgumentInfo(@NotNull String name, @NotNull CommandArgument<T> param, @Nullable T defaultValue) {
        this.name = name;
        this.param = param;
